...
const maindata = [
  ...
  },
  {
    id: 3,
    name: "K-Drama Movies",
    url: `https://api.themoviedb.org/3/discover/movie?api_key=${process.env.NEXT_PUBLIC_API_KEY}&with_origin_country=KR&sort_by=popularity.desc&page=1`,
  },
  {
    id: 4,
    name: "K-Drama Shows",
    url: `https://api.themoviedb.org/3/discover/tv?api_key=${process.env.NEXT_PUBLIC_API_KEY}&with_origin_country=KR&sort_by=popularity.desc&page=1`,
  },
  {
    id: 5,
    name: "Anime Movies",
    url: `https://api.themoviedb.org/3/discover/movie?api_key=${process.env.NEXT_PUBLIC_API_KEY}&with_genres=16&sort_by=popularity.desc&page=1`,
  },
  {
    id: 6,
    name: "Anime Shows",
